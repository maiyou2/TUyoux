...
<head>
    ...
    <%--<meta charset="utf-8">--%>
    <title>详情</title>
    <link rel="shortcut icon" href="http://www.lvmama.com/favicon.ico" type="${pageContext.request.contextPath}/statics/image/x-icon">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/statics/css/chanel.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/statics/css/index.php2.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/statics/css/buttons.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/statics/css/orderV2.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/statics/css/dialog.css">
    <link id="ui-components" rel="stylesheet" href="${pageContext.request.contextPath}/statics/css/ui-components.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/statics/css/share_popup.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/statics/css/select_share.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/statics/css/select_share2.css">
    <script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/jquery-1.8.3.min.js"></script>
    <script type="text/javascript" async charset="utf-8" src="${pageContext.request.contextPath}/statics/js/blade_track_cn.js"></script>
    <script type="text/javascript" async src="${pageContext.request.contextPath}/statics/js/ga.js"></script>
    <script src="${pageContext.request.contextPath}/statics/js/cp-v3.js" type="text/javascript"></script>
    <script type="${pageContext.request.contextPath}/statics/text/javascript" src="${pageContext.request.contextPath}/statics/js/zz.js"></script>
    <script src="${pageContext.request.contextPath}/statics/js/bcore.min.js" type="text/javascript"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/lvmamaUI.js" ></script>
...
<div >
    <img src="${pageContext.request.contextPath}/statics/images/newBtn_bg.gif" style="display: none;" data-bd-imgshare-binded="1">
    <!--head start-->
    <!-- 公共头部开始  -->
    <!-- topbar\\ -->
    <div class="p_lv-topbar">
        <div class="tapbar-inner p_wrap">
            <ul class="p_top-link">
                <li class="p_dropdown" id="wdlmm"><a class="p_lvlink p_lvlink1" href="#" rel="nofollow" style="">我的驴妈妈 </a>
            ...
            <div class="p_welcome"> <span>您好，欢迎来到驴妈妈！</span> <a class="p_login" href="#">登录</a> <a href="#">注册</a> </div>
        </div>
    </div>
    <!-- //.topbar -->
    ...
    <div class="lv-header">
        <div class="header-inner wrap">
            ...
            <div id="adPro" data-type="ad" class="lv-adPro" data-adsrc="http://lvmamim.allyes.com/main/s?user=lvmama_2013|abroad_2013|ticket_2013_flag01&amp;db=lvmamim&amp;border=0&amp;local=yes#300px#60px">
                <iframe scrolling="no" frameborder="0" marginwidth="0" marginheight="0" style="width:300px;height:60px;" src="${pageContext.request.contextPath}/statics/images/s.htm"></iframe>
            </div>
        </div>
    </div>
    <!-- //.lv-header -->
        ...
        <div class="main">
            <div style="position:absolute; right:-18px;">
                <div class="fuchuang" style="display:none;">
                    <div style="width:102px; height:210px;">
                        <p class="fu_top"><img src="${pageContext.request.contextPath}/statics/images/home_phone_v6.png"><span></span></p>
                    </div>
                    <ul class="second">
                        <li><a href="#">购物车</a></li>
                        <li><a href="#">最近查看</a></li>
            ...
            <div class="dtl_infobox clearfix">
                ...
                <div class="dtl_tit">
                    ...
                    <script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"16"},"share":{},"image":{"viewList":["qzone","tsina","tqq","renren","weixin"],"viewText":"分享到：","viewSize":"16"},"selectShare":{"bdContainerClass":null,"bdSelectMiniList":["qzone","tsina","tqq","renren","weixin"]}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='${pageContext.request.contextPath}/statics/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];
                    </script>
                    <!-- Baidu Button END -->
                </div>
                <!--infobox-tit-->
                        ...
                        <div class="dtl_focusbox">
                            <ul class="dtl_crtimg">
                                <li style="display: none;">
                                    <img src="${pageContext.request.contextPath}/statics/images/HWM3C.jpg" width="440px" height="220px" data-bd-imgshare-binded="1"></li>
                                <li style="display: list-item;">
                                    <img src="${pageContext.request.contextPath}/statics/images/7HDMC.jpg" width="440px" height="220px" data-bd-imgshare-binded="1"></li>
                                <li style="display: none;">
                                    <img src="${pageContext.request.contextPath}/statics/images/27WCT.jpg" width="440px" height="220px" data-bd-imgshare-binded="1"></li>
                                <li style="display: none;">
                                    <img src="${pageContext.request.contextPath}/statics/images/DDX6H.jpg" width="440px" height="220px" data-bd-imgshare-binded="1"></li>
                            </ul>
                            <ul class="dtl_focuslist">
                                <li class="">
                                    <img src="${pageContext.request.contextPath}/statics/images/HWM3C(1).jpg" width="97" height="71" alt="哈库拉岛CHAAYA LAGOON岛4晚6天游*4晚水屋Water Bungalow*一价全包*5M航空(BJ)" rev="http://s1.lvjs.com.cn/580x290/pics/super/2012/04/HWM3C.jpg" data-bd-imgshare-binded="1">
                                    <span class="zz_panel"></span>
                                </li>
                                <li class="dtl_focuslist">
                                    <img src="${pageContext.request.contextPath}/statics/images/7HDMC(1).jpg" width="97" height="71" alt="哈库拉岛CHAAYA LAGOON岛4晚6天游*4晚水屋Water Bungalow*一价全包*5M航空(BJ)" rev="http://s3.lvjs.com.cn/580x290/pics/super/2012/04/7HDMC.jpg" data-bd-imgshare-binded="1">
                                    <span class="zz_panel"></span>
                                </li>
                                <li class="">
                                    <img src="${pageContext.request.contextPath}/statics/images/27WCT.jpg" width="97" height="71" alt="哈库拉岛CHAAYA LAGOON岛4晚6天游*4晚水屋Water Bungalow*一价全包*5M航空(BJ)" rev="http://s2.lvjs.com.cn/580x290/pics/super/2012/04/27WCT.jpg" data-bd-imgshare-binded="1">
                                    <span class="zz_panel"></span>
                                </li>
                                <li class="">
                                    <img src="${pageContext.request.contextPath}/statics/images/DDX6H(1).jpg" width="97" height="71" alt="哈库拉岛CHAAYA LAGOON岛4晚6天游*4晚水屋Water Bungalow*一价全包*5M航空(BJ)" rev="http://s1.lvjs.com.cn/580x290/pics/super/2012/04/DDX6H.jpg" data-bd-imgshare-binded="1">
                                    <span class="zz_panel"></span>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="dtl_box_right clearfix">
                        <div class="dtl_box_r_topbox">
                            <div class="dtl_boxr_txt1">
                                ...
                                <label>出发/目的地：</label>
                                北京
                                <img width="32" height="5" align="absmiddle" class="dtl_goto_icon" alt=" " src="${pageContext.request.contextPath}/statics/images/arrow.gif" data-bd-imgshare-binded="1">
                            ...
                            <div class="play_date">
                                ...
                                <div class="ewm_box ewm_box_xl">
                                    <img src="${pageContext.request.contextPath}/statics/images/60971.png" width="75" height="75" alt="手机订购二维码" data-bd-imgshare-binded="1">
                                    <p>
                                        用驴妈妈app扫描此二维码
                                        <span>手机订购更优惠</span>
                                    </p>
            ...
            <div class="row pro_special" style="position:relative;">
				...
				<span style="font-family:Microsoft YaHei;font-size:16px;">
					<span style="color:#000000;">
						<img border="0" alt="" src="${pageContext.request.contextPath}/statics/images/UVUQH.jpg" data-bd-imgshare-binded="1">
						&nbsp;&nbsp;&nbsp;&nbsp;
						<img border="0" alt="" src="${pageContext.request.contextPath}/statics/images/C9PO5.jpg" data-bd-imgshare-binded="1"></span>
				</span>
                    </p>
                    <p>
                        <strong>
				...
				<span style="font-family:Microsoft YaHei;font-size:16px;">
					<span style="color:#000000;">
						<img border="0" alt="" src="${pageContext.request.contextPath}/statics/images/DD98B.jpg" data-bd-imgshare-binded="1">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<img border="0" alt="" src="${pageContext.request.contextPath}/statics/images/ANOXT.jpg" data-bd-imgshare-binded="1"></span>
				</span>
                    </p>
                    <p>
				<span style="font-family:Microsoft YaHei;font-size:16px;">
				...
				<span style="font-family:Microsoft YaHei;font-size:16px;">
					<span style="color:#000000;">
						<img border="0" alt="" src="${pageContext.request.contextPath}/statics/images/BDAPT.jpg" data-bd-imgshare-binded="1">
						&nbsp;&nbsp;&nbsp;&nbsp;
						<img border="0" alt="" src="${pageContext.request.contextPath}/statics/images/7GON4.jpg" data-bd-imgshare-binded="1"></span>
				</span>
                    </p>
                    <p>
                        <strong>
				...
				<span style="font-family:Microsoft YaHei;font-size:16px;">
					<span style="color:#000000;">
						<img border="0" alt="" src="${pageContext.request.contextPath}/statics/images/OIKHJ.jpg" data-bd-imgshare-binded="1">
						&nbsp;&nbsp;&nbsp;&nbsp;
						<img border="0" alt="" src="${pageContext.request.contextPath}/statics/images/SFUAJ.jpg" data-bd-imgshare-binded="1"></span>
				</span>
                    </p>
                </div>
                ...
                <div class="day day_rights_none">
                    ...
                    <div class="day_left">
                        ...
                        <div class="day_img">
                            ...
                            <img class="day_img_left" width="320" height="240" src="${pageContext.request.contextPath}/statics/images/0XPAM.jpg" title="北京" data-bd-imgshare-binded="1">

                            <img class="day_img_right" width="320" height="240" src="${pageContext.request.contextPath}/statics/images/2E3RZ.jpg" title="马尔代夫" data-bd-imgshare-binded="1"></div>
                ...
                <div class="day day_rights_none">
                    ...
                    <div class="day_left">
                        ...
                        <div class="day_img">
                            ...
                            <img class="day_img_left" width="320" height="240" src="${pageContext.request.contextPath}/statics/images/4GG3C.jpg" title="马尔代夫" data-bd-imgshare-binded="1">

                            <img class="day_img_right" width="320" height="240" src="${pageContext.request.contextPath}/statics/images/LYXG4.jpg" title="马尔代夫" data-bd-imgshare-binded="1"></div>
                ...
                <div class="day day_rights_none">
                    ...
                    <div class="day_left">
                        ...
                        <div class="day_img">
                            ...
                            <img class="day_img_left" width="320" height="240" src="${pageContext.request.contextPath}/statics/images/N0N8U.jpg" title="马尔代夫" data-bd-imgshare-binded="1">

                            <img class="day_img_right" width="320" height="240" src="${pageContext.request.contextPath}/statics/images/F0YA6.jpg" title="马尔代夫" data-bd-imgshare-binded="1"></div>
                ...
                <div class="day day_rights_none">
                    ...
                    <div class="day_left">
                        ...
                        <div class="day_img">
                            ...
                            <img class="day_img_left" width="320" height="240" src="${pageContext.request.contextPath}/statics/images/2IZFE.jpg" title="马尔代夫" data-bd-imgshare-binded="1">

                            <img class="day_img_right" width="320" height="240" src="${pageContext.request.contextPath}/statics/images/4HG1V.jpg" title="马尔代夫" data-bd-imgshare-binded="1"></div>
                ...
                <div class="day day_rights_none">
                    ...
                    <div class="day_left">
                        ...
                        <div class="day_img">
                            ...
                            <img class="day_img_left" width="320" height="240" src="${pageContext.request.contextPath}/statics/images/EOV7K.jpg" title="马尔代夫" data-bd-imgshare-binded="1">

                            <img class="day_img_right" width="320" height="240" src="${pageContext.request.contextPath}/statics/images/Z90HR.jpg" title="马尔代夫" data-bd-imgshare-binded="1"></div>
                ...
                <div class="day day_rights_none">
                    ...
                    <div class="day_left">
                        ...
                        <div class="day_img">
                            ...
                            <img class="day_img_left" width="320" height="240" src="${pageContext.request.contextPath}/statics/images/MGF1X.jpg" title="北京" data-bd-imgshare-binded="1">

                            <img class="day_img_right" width="320" height="240" src="${pageContext.request.contextPath}/statics/images/064JL.jpg" title="马尔代夫" data-bd-imgshare-binded="1"></div>
				...
				>-->
               	...
               	条
                            ...
                            <div class="u_comment">
                                <dl class="last">
                                    <dt>
                                        <img src="${pageContext.request.contextPath}/statics/images/default-photo.gif" width="76" height="76" data-bd-imgshare-binded="1">
                                        <span>lv1381174****</span>
                                    </dt>
                                    <dd>
		...
		-->
            ...
            <div style="position:relative;">
                <a rel="nofollow" href=" " target="_blank" class="product-banner" hidefocus="false" >
                    <img src="${pageContext.request.contextPath}/statics/images/productBanner2.jpg" width="1000" height="80" data-bd-imgshare-binded="1">
                </a>
            ...
            <div class="row important_prompt" style="position:relative;">
                ...
                <dl>
                    ...
                    <dd>2、单房差：报价是按照2人入住1间房计算的价格，如您的订单产生单房差，驴妈妈将向您收取相应的费用，具体请来电咨询客服。</dd>
                    <dd>
                    ...
                    <dd>8、为确保游客的游程顺利，驴妈妈旅游网建议游客自行选择购买旅游意外保险；</dd>
                    <dd>
                        9、根据国家相关法规，若因人力不可抗拒的因素而造成对行程的影响，旅行社将协助游客进行解决，但不承担相应损失，若因此而增加的费用，敬请游客自己承担；
                    </dd>
                    <dd>
                        10、建议您保持良好的出游心态，互相理解，互相尊重，凡事友好协商，祝您拥有愉快而难忘的旅程。请您订购前详细阅读《驴妈妈旅游网线路产品预订协议》，于并订购后尽早确认《旅游合同》。而出游即代表您已认可以上的重要条款。
                    </dd>
                    <dd>
                        ★如遇支付问题，游客可到驴妈妈北京分公司支付现金：北京市朝阳区左家庄曙光西里甲6号院时间国际大厦1号楼907-908室 电话：010-59762904
                    </dd>
                    <br>
                    <dd>
                    ...
                    <br>
                    <dd>
                        如需开具旅游发票(仅限支付给驴妈妈的订单用户)，请与客服专员确定发票内容与抬头及准确的发票邮寄地址，我司在收到邮寄地址信息后向您寄送发票；为避免因发生不可抗力或意外事项致实际消费额与发票开具的相应数额不符，建议您在游玩归来后两个月内索领取发票。
                    </dd>
                </dl>
                ...
                <dl>
                    ...
                    <dd>
                        联合组团：驴妈妈联合旅行社供应商共同开发的线路产品，所选用的旅游批发供应商均经过严格筛选，其在市场中拥有较高美誉度并在同行业中长期占有稳定的市场份额。在产品开发中关注控制产品价格同时更注重提升产品品质，让您以更低价格体验更好服务。
                    </dd>
...
<input type="text" size="30" id="visaEmail" value="" style="background:transparent;border:1px solid #CDC28D;"></span>
            ...
            <div class="row dest_intelligence">
                <dl>
                    <dt>马尔代夫</dt>
                    <dd>
                        <img src="${pageContext.request.contextPath}/statics/images/img_90_90.jpg" height="60" width="120" data-bd-imgshare-binded="1">
                        <p>
...
<a target="_blank" href="" hidefocus="false">九寨沟旅游攻略</a>
    ...
    <script src="${pageContext.request.contextPath}/statics/js/copyright.js"></script>
    <!-- 公共底部  -->
    <!-- footer\ -->
    <!-- copyright\ -->
    <!-- //footer -->
...
//代码转移到89行-->
    ...
    <script type="text/javascript" async src="${pageContext.request.contextPath}/statics/js/trace.js"></script>
    <script type="text/javascript" async charset="utf-8" src="${pageContext.request.contextPath}/statics/js/lvmama.js"></script>
    <script>
...
<input name="mobileLoginText" type="text" id="mobileLoginText" onblur="mobileRegisterOnBlur(&#39;mobileLoginText&#39;,&#39;mobileLoinTextSuccessTip&#39;,&#39;mobileLoinTextErrorTip&#39;)">
...
<a class="quickBuy" onclick="rapidRegister()" href="javascript:void(0)">
	<img src="${pageContext.request.contextPath}/statics/images/quickBuy.gif" alt="快速预订" style="cursor:pointer;" data-bd-imgshare-binded="1"></a>
</span>
                </p>
                <p>
<span class="inputValue">
<em class="contTsInfo">我们会将您注册为驴妈妈会员，手机号为您的用户名，密码将通过免费短信发送到您手机。</em>
</span>
                </p>
            </div>
            <div class="contRight">
...
<img id="image" src="${pageContext.request.contextPath}/statics/images/checkcode.htm" data-bd-imgshare-binded="1">
<a href="http://www.lvmama.com/product/60971#" class="link_blue" onclick="refreshCheckCode(&#39;image&#39;);return false;">换一张</a>
</span>
                </p>
...
<a class="quickBuy" href="javascript:void(0)" onclick="login()">
	<img src="${pageContext.request.contextPath}/statics/images/LoginAndBuy.gif" alt="登录，继续订购" onclick="login()" style="cursor:pointer;" data-bd-imgshare-binded="1"></a>
<a class="findPass" href="" target="_blank">忘记密码？</a>
                ...
                <div class="weiboLogin">
                    ...
                    <div class="weiboBtn">
                        <p>
                            ...
                            <a class="weiboBtnA login_conQQ" href="" target="_unionlogin" onclick="tipsWindow(&#39;tipsWindow&#39;,&#39;bgColor&#39;);">QQ</a>
                            <a class="weiboBtnA login_conBD" href="" target="_unionlogin" onclick="tipsWindow(&#39;tipsWindow&#39;,&#39;bgColor&#39;);">百度</a>
                        </p>
                        <a class="weiboBtnA login_conSN" href="" target="_unionlogin" onclick="tipsWindow(&#39;tipsWindow&#39;,&#39;bgColor&#39;);">新浪微博</a>
                        <a class="weiboBtnA login_conALP"  href="" target="_unionlogin" onclick="tipsWindow(&#39;tipsWindow&#39;,&#39;bgColor&#39;);">支付宝</a>
                        <a class="weiboBtnA login_conKX" href="" target="_blank" style="padding-left:22px;">开心网</a>
                        <a class="weiboBtnA login_conSD" href="" target="_unionlogin" onclick="tipsWindow(&#39;tipsWindow&#39;,&#39;bgColor&#39;);">盛大</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="tipsWindow_n">
        <p>
            <img src="${pageContext.request.contextPath}/statics/images/warning.gif" data-bd-imgshare-binded="1">&nbsp;请在联合登录前不要关闭此窗口。完成登录后根据您好的情况点击下面的按钮：</p>
        <strong>请在新开网页上完成登录后再选择。</strong>
        <div class="tbtn">
            <input name="completePayBtn" type="button" value="已完成登录" id="completePayBtn" onclick="completeLogin()">
            <input type="button" value="登录遇到问题" onclick="javascript:window.open(&#39;http://www.lvmama.com/public/reg_and_login&#39;)"></div>
    ...
    <iframe src="${pageContext.request.contextPath}/statics/images/cm.htm" scrolling="no" width="1" height="1" style="display: none;"></iframe>
    ...
    $(function(){
        ...
        $("#wdlmm").hover(function(){
            ...
            $(this).find(".p_lvlink1").css({
                ...
                height: "24px",
                background:"url(${pageContext.request.contextPath}/statics/images/sanjiao2.png) #fff no-repeat 74px 10px"
            });
            ...
            $(this).find(".p_lvlink1").css({
                ...
                height: "18px" ,
                background:"url(${pageContext.request.contextPath}/statics/images/sanjiao.png) no-repeat 74px 10px"
