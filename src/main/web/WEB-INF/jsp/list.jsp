...
<head>
    ...
    <script src="${pageContext.request.contextPath}/statics/js/pindao1.js"></script>

    <!--[if IE 6]>
    <script src="${pageContext.request.contextPath}/statics/js/iepng.js"></script>
...
<div class="p_lv-topbar">
    <div class="tapbar-inner p_wrap">
        <ul class="p_top-link">
            <li class="p_dropdown" id="wdlmm"><a class="p_lvlink p_lvlink1" href="#" rel="nofollow">我是你爹 </a>
        ...
        <div class="p_welcome"> <span>您好，欢迎来到我是你爹的旅游网！</span> <a class="p_login" href="#">登录</a> <a href="#">注册</a> </div>
    </div>
</div>
<!-- //.topbar -->

<div class="p_header">
    <div class="header-inner p_wrap"> <span id="p_hotline" class="p_lv-hotline">1010-6060</span> <a class="p_lv-logo">旅游网</a>
...
<div class="p_search-box p_wrap">
    ...
    <div class="p_from">
        <div class="p_city1" style="border-bottom-color: rgb(70, 140, 0); background:100px 12px no-repeat;">深圳
    ...
    <div class="search-aside">
        ...
        <div class="aside-box lv-bd side-stuan clearfix">
            ...
            <ul class="stuan-list">
                <li class="stuan-item">
                    <p class="img">
                        <a target="_blank" href="#" ><img src="${pageContext.request.contextPath}/statics/images/9O0MF.jpg" width="178" height="89"></a>
        ...
        <div class="aside-box lv-bd travel-index">
            ...
            <a target="_blank" href="#" >
                <img src="${pageContext.request.contextPath}/statics/images/1288335977153_small.jpg" width="178" height="89">
            </a>
            <p>
        ...
        <div id="guide_data_div" class="aside-box lv-bd side-guide" placeid="3546">
            ...
            <div class="imgtext clearfix">
                <p class="img">
                    <a target="_blank" href="#">
                        <img src="${pageContext.request.contextPath}/statics/images/20140327044937977.jpg" width="89" height="124"></a>
                </p>
        ...
        <form class="J_price" action="#">
            ...
            <div class="slist-item">
                <dl class="search-result-item line-info">
                    <dt class="img">
                        <a rel="nofollow" target="_blank" href="#" >
                            <img src="${pageContext.request.contextPath}/statics/images/IWF73.jpg" width="168" height="86">
                        </a>
                        <span class="s-type">
                    自由行套餐 (机票+酒店)
            </span>
                    ...
                    <dd class="info">
                        ...
                        <span class="tags101"><img src="${pageContext.request.contextPath}/statics/images/zs.jpg" width="64" height="19"></span>
                    ...
                    <dd class="intro">
                        <h5>
                            <a rel="nofollow" target="_blank" href="#" onclick="coremetrics('&#39;成都_马尔代夫_route_1-1_73579&#39;');" >马尔代夫阿雅达（Ayady）4晚6日或5晚7日自由行*成都直飞 内飞上岛</a>
                        </h5>
                ...
                <dl class="search-result-item line-info">
                    <dt class="img">
                        <a rel="nofollow" target="_blank" href="#"  >
                            <img src="${pageContext.request.contextPath}/statics/images/DOGCH.jpg" width="168" height="86">
                        </a>
                        <span class="s-type">
                    自由行套餐 (机票+酒店)
            </span>
                ...
                <dl class="search-result-item line-info">
                    <dt class="img">
                        <a rel="nofollow" target="_blank" href="#" >
                            <img src="${pageContext.request.contextPath}/statics/images/3PW3A.jpg" width="168" height="86">
                        </a>
                        <span class="s-type">
                    自由行套餐 (机票+酒店)
            </span>
                ...
                <dl class="search-result-item line-info">
                    <dt class="img">
                        <a rel="nofollow" target="_blank" href="#"  >
                            <img src="${pageContext.request.contextPath}/statics/images/VF8M6.jpg" width="168" height="86">
                        </a>
                        <span class="s-type">
                    自由行套餐 (机票+酒店)
            </span>
                ...
                <dl class="search-result-item line-info">
                    <dt class="img">
                        <a rel="nofollow" target="_blank" href="#">
                            <img src="${pageContext.request.contextPath}/statics/images/XUEWN.jpg" width="168" height="86">
                        </a>
                        <span class="s-type">
                    自由行套餐 (机票+酒店)
            </span>
                ...
                <dl class="search-result-item line-info">
                    <dt class="img">
                        <a rel="nofollow" target="_blank" href="#" >
                            <img src="${pageContext.request.contextPath}/statics/images/8YFO5.jpg" width="168" height="86">
                        </a>
                        <span class="s-type">
                    自由行套餐 (机票+酒店)
            </span>
                ...
                <dl class="search-result-item line-info">
                    <dt class="img">
                        <a rel="nofollow" target="_blank" href="#"  >
                            <img src="${pageContext.request.contextPath}/statics/images/MTO17.jpg" width="168" height="86">
                        </a>
                        <span class="s-type">
                    自由行套餐 (机票+酒店)
            </span>
                ...
                <dl class="search-result-item line-info">
                    <dt class="img">
                        <a rel="nofollow" target="_blank" href="#" >
                            <img src="${pageContext.request.contextPath}/statics/images/YE4YP.jpg" width="168" height="86">
                        </a>
                        <span class="s-type">
                    自由行套餐 (机票+酒店)
            </span>
                ...
                <dl class="search-result-item line-info">
                    <dt class="img">
                        <a rel="nofollow" target="_blank" href="#">
                            <img src="${pageContext.request.contextPath}/statics/images/8ODL4.jpg" width="168" height="86">
                        </a>
                        <span class="s-type">
                    自由行套餐 (机票+酒店)
            </span>
                    ...
                    <dd class="intro">
                        <h5>
                            <a rel="nofollow" target="_blank" href="#" onclick="coremetrics(&#39;成都_马尔代夫_route_1-9_32429&#39;);" >马尔代夫薇拉瓦鲁岛（Angsana Velavaru）4晚6日或5晚7日自由行*成都直飞 内飞上岛</a>
                        </h5>
                ...
                <dl class="search-result-item line-info">
                    <dt class="img">
                        <a rel="nofollow" target="_blank" href="#"  >
                            <img src="${pageContext.request.contextPath}/statics/images/VN37X.jpg" width="168" height="86">
                        </a>
                        <span class="s-type">
                    自由行套餐 (机票+酒店)
            </span>
...
<!-- // 订购指南等结束 -->
<!--主要内容结束-->
<div class="p_ad3 p_wrap"> <img src="${pageContext.request.contextPath}/statics/images/ad3.png" alt=""> </div>
<!-- //页面底部 -->
